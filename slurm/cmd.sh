...
sbatch train_predict.sh --save_dir logs/lstm/ft_lr1e-4_wd1e-6 --max_epochs 500 --lr 1e-4 --weight_decay 1e-6 --sequence_length 1000 --stride 1 --model_type lstm --model_dir logs/lstm/base --finetune # Best so far
sbatch train_predict.sh --save_dir logs/lstm/ft_lr1e-3_wd1e-6 --max_epochs 500 --lr 1e-3 --weight_decay 1e-6 --sequence_length 1000 --stride 1 --model_type lstm --model_dir logs/lstm/base --finetune
...
sbatch train_predict.sh --save_dir logs/lstm/ft_m1 --max_epochs 200 --model_idx 1 --model_type lstm --lr 1e-4 --weight_decay 1e-6 --sequence_length 1000 --stride 2 --teleop --finetune --model_dir logs/lstm/base
sbatch train_predict.sh --save_dir logs/lstm/ft_m2 --max_epochs 200 --model_idx 2 --model_type lstm --lr 1e-4 --weight_decay 1e-6 --sequence_length 1000 --stride 2 --teleop --finetune --model_dir logs/lstm/base
...
# LSTM
sbatch train_predict.sh --save_dir logs/lstm/scratch_m0 --max_epochs 500 --model_idx 0 --model_type lstm --lr 1e-3 --weight_decay 1e-6 --sequence_length 1000 --stride 2 --teleop
sbatch train_predict.sh --save_dir logs/lstm/scratch_m1 --max_epochs 500 --model_idx 1 --model_type lstm --lr 1e-3 --weight_decay 1e-6 --sequence_length 1000 --stride 2 --teleop
sbatch train_predict.sh --save_dir logs/lstm/scratch_m2 --max_epochs 500 --model_idx 2 --model_type lstm --lr 1e-3 --weight_decay 1e-6 --sequence_length 1000 --stride 2 --teleop
